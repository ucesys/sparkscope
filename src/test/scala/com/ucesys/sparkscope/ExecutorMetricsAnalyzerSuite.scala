...
class ExecutorMetricsAnalyzerSuite extends AnyFunSuite with MockFactory {
  ...
  def createDummyAppContext(): AppContext = {
    ...
    executor2Timespan.setStartTime(1695358675000L)
    executor2Timespan.setEndTime(1695358700000L)
    executor3Timespan.setStartTime(1695358691000L)
    ...
    new AppContext(
      new ApplicationInfo(appId, executor0Timespan.startTime,executor0Timespan.endTime),
