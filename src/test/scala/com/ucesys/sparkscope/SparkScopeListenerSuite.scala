...
class SparkScopeListenerSuite extends FunSuite with GivenWhenThen with MockitoSugar {
    ...
    val stageInfo = new StageInfo(stageId, 0, "", stageTasks, Seq.empty, Seq.empty, "", null, Seq.empty)
    ...
    val taskEnd1 = {
        ...
        SparkListenerTaskEnd(stageId, 999, "task type", null, taskInfo1, taskMetrics)
    }
    ...
    val taskEnd2 = {
        ...
        SparkListenerTaskEnd(stageId, 999, "task type", null, taskInfo2, taskMetrics)
    }
