...
class EventLogContextLoaderSuite extends FunSuite with MockFactory with GivenWhenThen {
    ...
    test("EventLogContextLoader finished") {
        ...
        assert(eventLogContext.appContext.executorMap("0").endTime.isEmpty)
        ...
        assert(eventLogContext.appContext.executorMap("1").endTime.isEmpty)
    ...
    test("EventLogContextLoader finished executors removed") {
        ...
        assert(eventLogContext.appContext.executorMap.size == 2)
        assert(eventLogContext.appContext.executorMap("0").startTime == 1698236098507L)
        assert(eventLogContext.appContext.executorMap("0").endTime.get == 1698236102012L)
        assert(eventLogContext.appContext.executorMap("0").cores == 2)
        assert(eventLogContext.appContext.executorMap("1").startTime == 1698236098540L)
        assert(eventLogContext.appContext.executorMap("1").endTime.get == 1698236103345L)
        assert(eventLogContext.appContext.executorMap("1").cores == 2)
    ...
    test("EventLogContextLoader finished stages test") {
        ...
        assert(eventLogContext.appContext.stages.head == stageTimeline(0, 1700654082972L, 1700654087848L, 2))
        assert(eventLogContext.appContext.stages(1) == stageTimeline(1, 1700654088379L, 1700654089900L, 2))
        assert(eventLogContext.appContext.stages(2) == stageTimeline(3, 1700654090188L, 1700654093628L, 20, Seq(2)))
        assert(eventLogContext.appContext.stages(3) == stageTimeline(6, 1700654093945L, 1700654094398L, 1, Seq(5)))
        assert(eventLogContext.appContext.stages(4) == stageTimeline(7, 1700654094935L, 1700654096905L, 2))
        assert(eventLogContext.appContext.stages(5) == stageTimeline(8, 1700654094986L, 1700654095595L, 4))
        assert(eventLogContext.appContext.stages(6) == stageTimeline(10, 1700654096963L, 1700654099016L, 20, Seq(9)))
        assert(eventLogContext.appContext.stages(7) == stageTimeline(13, 1700654099238L, 1700654099521L, 1, Seq(12)))
        assert(eventLogContext.appContext.stages(8) == stageTimeline(16, 1700654099596L, 1700654099829L, 1, Seq(15)))
        assert(eventLogContext.appContext.stages(9) == stageTimeline(20, 1700654099981L, 1700654100329L, 1, Seq(19)))
    }
    ...
    test("EventLogContextLoader corrupted events test") {
        ...
        assert(eventLogContext.appContext.executorMap("1").startTime == 1700654079478L)
        assert(eventLogContext.appContext.executorMap("1").endTime.isEmpty)
        assert(eventLogContext.appContext.executorMap("1").cores == 2)
    }
